!(function (t, e) {
    ...
    var _ = function (_, S) {
        ...
        var x = (function (t) {
            ...
            T = (function (t, e) {
                ...
                if ((s = a.exec(t) || n.exec(t))) {
                    var l = s[1];
                    return { year: 100 * parseInt(l, 10), restDateString: t.slice(l.length) };
                }
                return { year: null };
            })(x.date, k),
            F = T.year,
        ...
        if (E) {
            ...
            return (
                ...
                x.timezone
                    ? (($ = x.timezone),
                      (Y = (H = y.exec($)) ? 0 : (H = b.exec($)) ? ((O = 60 * parseInt(H[2], 10)), "+" === H[1] ? -O : O) : (H = w.exec($)) ? ((O = 60 * parseInt(H[2], 10) + parseInt(H[3], 10)), "+" === H[1] ? -O : O) : 0))
                    : ((Y = new Date(C + I).getTimezoneOffset()), (Y = new Date(C + I + Y * s).getTimezoneOffset())),
                new Date(C + I + Y * s)
            );
        }
        var $, H, O;
    ...
    var R = function () {
            ...
            return (
                ...
                { formatters: h, formattingTokensRegExp: L(h) }
            );
        },
        A = {
    ...
    var lt,
        ct = { componentUpdated: dt, inserted: dt };
    function dt(t, e, s) {
    ...
    var ft = {
            render: function () {
                var t = this,
                    e = t.$createElement,
                    s = t._self._c || e;
                return s("transition", { attrs: { name: "asd__fade" } }, [
                    s(
                        "div",
                        {
                            directives: [
                                { name: "show", rawName: "v-show", value: t.showDatepicker, expression: "showDatepicker" },
                        ...
                        [
                            t.showFullscreen
                                ? s("div", { staticClass: "asd__mobile-header asd__mobile-only" }, [
                                      s(
                                          "button",
                                          { staticClass: "asd__mobile-close", attrs: { type: "button", "aria-label": t.ariaLabels.closeDatepicker }, on: { click: t.closeDatepicker } },
                                          [t.$slots["close-icon"] ? t._t("close-icon") : s("div", { staticClass: "asd__mobile-close-icon", attrs: { "aria-hidden": "true" } }, [t._v("X")])],
                                          2
                                      ),
                                      t._v(" "),
                                      s("h3", [t._v(t._s(t.mobileHeader || t.mobileHeaderFallback))]),
                                  ])
                                : t._e(),
                            t._v(" "),
                            s(
                                ...
                                [
                                    s("div", { staticClass: "asd__change-month-button asd__change-month-button--previous" }, [
                                        s(
                                            "button",
                                            { attrs: { type: "button", "aria-label": t.ariaLabels.previousMonth }, on: { click: t.previousMonth } },
                                            [
                                                t.$slots["previous-month-icon"]
                                                    ? t._t("previous-month-icon")
                                                    : s("svg", { attrs: { viewBox: "0 0 1000 1000" } }, [
                                                          s("path", {
                                                              attrs: {
                                                                  d:
                                    ...
                                    t._v(" "),
                                    s("div", { staticClass: "asd__change-month-button asd__change-month-button--next" }, [
                                        s(
                                            "button",
                                            { attrs: { type: "button", "aria-label": t.ariaLabels.nextMonth }, on: { click: t.nextMonth } },
                                            [
                                                t.$slots["next-month-icon"]
                                                    ? t._t("next-month-icon")
                                                    : s("svg", { attrs: { viewBox: "0 0 1000 1000" } }, [
                                                          s("path", {
                                                              attrs: {
                                                                  d:
                                    ...
                                    t._v(" "),
                                    t._l(t.showMonths, function (e, n) {
                                        return s(
                                            "div",
                                            { key: e, staticClass: "asd__days-legend", style: [t.monthWidthStyles, { left: t.width * n + "px" }] },
                                            t._l(t.daysShort, function (e, n) {
                                                return s("div", { key: n, staticClass: "asd__day-title" }, [t._v(t._s(e))]);
                                            })
                                        );
                                    }),
                                ],
                            ...
                            s(
                                "div",
                                { staticClass: "asd__inner-wrapper", style: t.innerStyles },
                                [
                                    s(
                                        "transition-group",
                                        { attrs: { name: "asd__list-complete", tag: "div" } },
                                        t._l(t.months, function (e, n) {
                                            return s("div", { key: e.firstDateOfMonth, staticClass: "asd__month", class: { "asd__month--hidden": 0 === n || n > t.showMonths }, style: t.monthWidthStyles }, [
                                                s("div", { staticClass: "asd__month-name" }, [
                                                    t.showMonthYearSelect
                                                        ? s(
                                                              "select",
                                                              {
                                                                  directives: [
                                                                      { name: "model", rawName: "v-model", value: e.monthName, expression: "month.monthName" },
                                                                      { name: "resize-select", rawName: "v-resize-select" },
                                                                  ],
                                                                  staticClass: "asd__month-year-select",
                                                                  attrs: { tabindex: 0 === n || n > t.showMonths ? -1 : 0 },
                                                                  on: {
                                                                      change: [
                                                                          function (s) {
                                                              ...
                                                              t._l(t.monthNames, function (i, r) {
                                                                  return s("option", { key: "month-" + n + "-" + i, attrs: { disabled: t.isMonthDisabled(e.year, r) }, domProps: { value: i } }, [t._v(t._s(i))]);
                                                              })
                                                          )
                                                        : s("span", [t._v(t._s(e.monthName))]),
                                                    t._v(" "),
                                                    t.showMonthYearSelect
                                                        ? s(
                                                              "select",
                                                              {
                                                                  directives: [{ name: "model", rawName: "v-model", value: e.year, expression: "month.year" }],
                                                                  staticClass: "asd__month-year-select",
                                                                  attrs: { tabindex: 0 === n || n > t.showMonths ? -1 : 0 },
                                                                  on: {
                                                                      change: [
                                                              ...
                                                              [
                                                                  -1 === t.years.indexOf(e.year) ? s("option", { key: "month-" + n + "-" + t.year, attrs: { disabled: !0 }, domProps: { value: e.year } }, [t._v(t._s(e.year))]) : t._e(),
                                                                  t._v(" "),
                                                                  t._l(t.years, function (e) {
                                                                      return s("option", { key: "month-" + n + "-" + e, domProps: { value: e } }, [t._v(t._s(e))]);
                                                                  }),
                                                              ],
                                                              2
                                                          )
                                                        : s("span", [t._v(t._s(e.year))]),
                                                ]),
                                                t._v(" "),
                                                s("table", { staticClass: "asd__month-table", attrs: { role: "presentation" } }, [
                                                    s(
                                                        "tbody",
                                                        t._l(e.weeks, function (e, n) {
                                                            return s(
                                                                "tr",
                                                                { key: n, staticClass: "asd__week" },
                                                                t._l(e, function (e, n) {
                                                                    var i = e.fullDate,
                                                                        r = e.dayNumber;
                                                                    return s(
                                                                        "td",
                                                                        {
                                                                            ...
                                                                            attrs: { "data-date": i, tabindex: t.isDateVisible(i) && t.isSameDate(t.focusedDate, i) ? 0 : -1, "aria-label": !!t.isDateVisible(i) && t.getAriaLabelForDate(i) },
                                                                            on: {
                                                                                mouseover: function () {
                                                                                    t.setHoverDate(i);
                                                                                },
                                                                            ...
                                                                            r
                                                                                ? s(
                                                                                      "button",
                                                                                      {
                                                                                          ...
                                                                                          attrs: { type: "button", tabindex: "-1", date: i, disabled: t.isDisabled(i) },
                                                                                          on: {
                                                                                              click: function () {
                                                                                                  t.selectDate(i);
                                                                                              },
                                    ...
                                    t._v(" "),
                                    t.showShortcutsMenuTrigger
                                        ? s("div", { class: { "asd__keyboard-shortcuts-menu": !0, "asd__keyboard-shortcuts-show": t.showKeyboardShortcutsMenu }, style: t.keyboardShortcutsMenuStyles }, [
                                              s("div", { staticClass: "asd__keyboard-shortcuts-title" }, [t._v(t._s(t.texts.keyboardShortcuts))]),
                                              t._v(" "),
                                              s(
                                                  "button",
                                                  {
                                                      ...
                                                      attrs: { tabindex: "0", "aria-label": t.ariaLabels.closeKeyboardShortcutsMenu },
                                                      on: { click: t.closeKeyboardShortcutsMenu },
                                                  },
                                                  [t.$slots["close-shortcuts-icon"] ? t._t("close-shortcuts-icon") : s("div", { staticClass: "asd__mobile-close-icon", attrs: { "aria-hidden": "true" } }, [t._v("X")])],
                                                  2
                                              ),
                                              t._v(" "),
                                              s(
                                                  ...
                                                  t._l(t.keyboardShortcuts, function (e, n) {
                                                      return s("li", { key: n }, [
                                                          s("span", { staticClass: "asd__keyboard-shortcuts-symbol", attrs: { "aria-label": e.symbolDescription } }, [t._v(t._s(e.symbol))]),
                                                          t._v(" " + t._s(e.label) + " "),
                                                      ]);
                                                  })
                                              ),
                            ...
                            t._v(" "),
                            "single" !== t.mode && t.showActionButtons
                                ? s("div", { staticClass: "asd__action-buttons" }, [
                                      s("button", { attrs: { type: "button" }, on: { click: t.closeDatepickerCancel } }, [t._v(t._s(t.texts.cancel))]),
                                      t._v(" "),
                                      s("button", { ref: "apply-button", style: { color: t.colors.selected }, attrs: { type: "button" }, on: { click: t.apply } }, [t._v(t._s(t.texts.apply))]),
                                  ])
                                : t._e(),
                            t._v(" "),
            ...
            directives: {
                                              ...
                                              h = {
                                                  ...
                                                  eventHandlers: r.events.map(function (e) {
                                                      return {
                                                          event: e,
                                                          handler: function (e) {
                                                              return n({ event: e, el: t, handler: a, middleware: o });
                                                          },
                                                      };
                                                  }),
                                              };
                ...
                })((lt = { exports: {} }), lt.exports),
                lt.exports).directive,
                resizeSelect: ct,
            },
            props: {
                ...
                showShortcutsMenuTrigger: { type: Boolean, default: !0 },
                showMonthYearSelect: { type: Boolean, default: !1 },
            ...
            data: function () {
                return {
                    ...
                    showMonths: 2,
                    colors: { selected: "#00a699", inRange: "#66e2da", selectedText: "#fff", text: "#565a5c", inRangeBorder: "#33dacd", disabled: "#fff", hoveredInRange: "#67f6ee" },
                    sundayFirst: !1,
                    ariaLabels: {
                    ...
                    texts: { apply: "Áp dụng", cancel: "Xóa",},                    
                    keys: { arrowDown: 40, arrowUp: 38, arrowRight: 39, arrowLeft: 37, enter: 13, pgUp: 33, pgDn: 34, end: 35, home: 36, questionMark: 191, esc: 27 },
                    startingDate: "",
                    months: [],
                    years: [],
                    width: 300,
            ...
            computed: {
                wrapperClasses: function () {
                    return { "asd__wrapper--datepicker-open": this.showDatepicker, "asd__wrapper--full-screen": this.showFullscreen, "asd__wrapper--inline": this.inline };
                },
                wrapperStyles: function () {
                    return {
                        position: this.inline ? "static" : "absolute",
                        top: this.inline ? "0" : this.triggerPosition.height + this.offsetY + 8 + "px",
                        left: this.alignRight ? "" : this.triggerPosition.left - this.triggerWrapperPosition.left + this.offset + "px",
                ...
                innerStyles: function () {
                    return { "margin-left": this.showFullscreen ? "-" + this.viewportWidth : "-" + this.width + "px" };
                },
                keyboardShortcutsMenuStyles: function () {
                    return { left: this.showFullscreen ? this.viewportWidth : this.width + "px" };
                },
                monthWidthStyles: function () {
                    return { width: this.showFullscreen ? this.viewportWidth : this.width + "px" };
                },
                ...
                visibleMonths: function () {
                    for (
                        var t = this.months.filter(function (t, e) {
                                return e > 0;
                            }),
                            e = [],
                            s = 0;
            ...
            watch: {
                ...
                datePropsCompound: function (t) {
                    this.dateOne !== this.selectedDate1 && ((this.startingDate = this.dateOne), this.setStartDates(), this.generateMonths(), this.generateYears()),
                        this.isDateTwoBeforeDateOne && ((this.selectedDate2 = ""), this.$emit("date-two-selected", ""));
                },
            ...
            methods: {
                ...
                getAriaLabelForDate: function (t) {
                    ...
                    return this.isDisabled(t)
                        ? this.ariaLabels.unavailableDate(e)
                        : this.isSelected(t)
                        ? this.ariaLabels.selectedDate(e)
                        : this.isRangeMode
                        ? this.isSelectingDate1
                            ? this.ariaLabels.chooseStartDate(e)
                            : this.ariaLabels.chooseEndDate(e)
                        : this.ariaLabels.chooseDate(e);
                },
                ...
                handleKeyboardInput: function (t) {
                    if (this.shouldHandleInput(t, this.keys.esc)) this.showKeyboardShortcutsMenu ? this.closeKeyboardShortcutsMenu() : this.closeDatepicker();
                        ...
                        var l = Y(this.focusedDate, { weekStartsOn: this.sundayFirst ? 0 : 1 }),
                            c = !q(l, this.focusedDate);
                        this.setFocusedDate(l), c && this.previousMonth();
                    } else if (this.shouldHandleInput(t, this.keys.end)) {
                        var d = at(this.focusedDate, { weekStartsOn: this.sundayFirst ? 0 : 1 }),
                ...
                setupDatepicker: function () {
                    if (
                        (this.$options.ariaLabels && (this.ariaLabels = ut(this.$options.ariaLabels)),
                        this.$options.keyboardShortcuts && (this.keyboardShortcuts = ut(this.$options.keyboardShortcuts)),
                        this.$options.dateLabelFormat && (this.dateLabelFormat = ut(this.$options.dateLabelFormat)),
                        this.$options.sundayFirst && (this.sundayFirst = ut(this.$options.sundayFirst)),
                        this.$options.colors)
                    ) {
                        var t = ut(this.$options.colors);
                        (this.colors.selected = t.selected || this.colors.selected),
                            (this.colors.inRange = t.inRange || this.colors.inRange),
                            (this.colors.hoveredInRange = t.hoveredInRange || this.colors.hoveredInRange),
                            (this.colors.selectedText = t.selectedText || this.colors.selectedText),
                            (this.colors.text = t.text || this.colors.text),
                            (this.colors.inRangeBorder = t.inRangeBorder || this.colors.inRangeBorder),
                            (this.colors.disabled = t.disabled || this.colors.disabled);
                    }
                    if (
                        (this.$options.monthNames && 12 === this.$options.monthNames.length && (this.monthNames = ut(this.$options.monthNames)),
                        this.$options.days && 7 === this.$options.days.length && (this.days = ut(this.$options.days)),
                        this.$options.daysShort && 7 === this.$options.daysShort.length && (this.daysShort = ut(this.$options.daysShort)),
                        this.$options.texts)
                    ) {
                ...
                getMonth: function (t) {
                    var e = P(t, "YYYY-MM-01"),
                        s = P(t, "YYYY"),
                        n = parseInt(P(t, "M"));
                    return { year: s, firstDateOfMonth: e, monthName: this.monthNames[n - 1], monthNumber: n, weeks: this.getWeeks(e) };
                },
                getWeeks: function (t) {
                    var e = { dayNumber: 0 },
                        s = U(t),
                    ...
                    for (var u = 0; u < s; u++) {
                        var l = u >= s - 1,
                            c = u + 1,
                            d = c < 10 ? "0" + c : c;
                        if ((o.push({ dayNumber: c, dayNumberFull: d, fullDate: n + "-" + i + "-" + d }), 7 === o.length)) a.push(o), (o = []);
                        else if (l) {
                ...
                selectDate: function (t) {
                    if (!(this.isBeforeMinDate(t) || this.isAfterEndDate(t) || this.isDateDisabled(t)))
                        return "single" === this.mode
                            ? ((this.selectedDate1 = t), void this.closeDatepicker())
                            : void (this.isSelectingDate1 || ot(t, this.selectedDate1)
                                  ? ((this.selectedDate1 = t), (this.isSelectingDate1 = !1), ot(this.selectedDate2, t) && (this.selectedDate2 = ""))
                                  : ((this.selectedDate2 = t),
                                    (this.isSelectingDate1 = !0),
                                    ht(this.selectedDate1, t) ? (this.selectedDate1 = "") : this.showActionButtons && this.$refs["apply-button"].focus(),
                                    this.allDatesSelected && this.closeAfterSelect && this.closeDatepicker()));
                },
                ...
                customizedDateClass: function (t) {
                    var e = "";
                    if (this.customizedDates.length > 0) for (var s = 0; s < this.customizedDates.length; s++) this.customizedDates[s].dates.indexOf(t) > -1 && (e += " asd__day--" + this.customizedDates[s].cssClass);
                    return e;
                },
                ...
                closeKeyboardShortcutsMenu: function () {
                    var t = this;
                    (this.showKeyboardShortcutsMenu = !1),
                        this.$nextTick(function () {
                ...
                positionDatepicker: function () {
                    ...
                    (this.triggerPosition = this.triggerElement.getBoundingClientRect()), (this.triggerWrapperPosition = t ? t.getBoundingClientRect() : { left: 0, right: 0 });
                    var e = document.documentElement.clientWidth || window.innerWidth;
                    (this.viewportWidth = e + "px"),
                        (this.isMobile = e < 768),
                        (this.isTablet = e >= 768 && e <= 1024),
